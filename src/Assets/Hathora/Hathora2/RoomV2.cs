...
namespace Hathora2
{
    ...
    public class RoomV2SDK: IRoomV2SDK
    {
        ...
        public async Task<CreateRoomResponse> CreateRoomAsync(CreateRoomSecurity security, Models.Operations.CreateRoomRequest request)
        {
            ...
            Debug.Log("output body content: ");
            Debug.Log(httpRequest.uploadHandler.data);
            Debug.Log(Utilities.SerializeJSON(request));
            ...
            switch (httpResponse.result)
            {
                ...
                case UnityWebRequest.Result.ProtocolError:
                    ...
                    Debug.Log("received errorresponse: " + httpResponse.responseCode.ToString());
            ...
            Debug.Log("received response: " + httpResponse.responseCode.ToString());
