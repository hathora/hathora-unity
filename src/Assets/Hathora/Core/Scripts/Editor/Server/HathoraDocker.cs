...
namespace Hathora.Core.Scripts.Editor.Server
{
    public static class HathoraDocker
    {
        ...
        /// <returns>"path/to/DockerFile"</returns>
        public static string GenerateDockerFileStr(HathoraServerDeployPaths _serverDeployPaths)
        {
            return $@"###########################################################
This Dockerfile is auto-generated by {nameof(GenerateDockerFileStr)}.cs
###########################################################
