...
namespace Hathora.Core.Scripts.Server.Editor
{
    ...
    public static class Hathora7z
    {
        ...
        public static async Task TarballDeployFilesVia7zAsync(
            HathoraServerDeployPaths deployPaths,
            ...
            CancellationToken _cancelToken = default)
        {
            ...
            string gzipResultLogs = await HathoraEditorUtils.ExecuteCrossPlatformShellCmdAsync(
            ...
            CancellationToken _cancelToken = default)
        {
            ...
            string tarResultLogs = await HathoraEditorUtils.ExecuteCrossPlatformShellCmdAsync(
