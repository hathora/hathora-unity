...
{
    /// <summary>
    ///  Class for testing RoomV2Api
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class RoomV2ApiTests : IDisposable
    {
        private RoomV2Api instance;

        public RoomV2ApiTests()
        {
            instance = new RoomV2Api();
        }
        ...
        /// <summary>
        /// Test an instance of RoomV2Api
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' RoomV2Api
            //Assert.IsType<RoomV2Api>(instance);
        }
        ...
        public void CreateRoomTest()
        {
            ...
            //string appId = null;
            //CreateRoomDeprecatedRequest createRoomDeprecatedRequest = null;
            //string roomId = null;
            //var response = instance.CreateRoom(appId, createRoomDeprecatedRequest, roomId);
            //Assert.IsType<ConnectionInfoV2>(response);
        }
