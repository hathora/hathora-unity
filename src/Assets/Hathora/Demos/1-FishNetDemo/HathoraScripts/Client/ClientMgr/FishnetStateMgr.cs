...
namespace Hathora.Demos._1_FishNetDemo.HathoraScripts.Client.ClientMgr
{
    ...
    {
        #region vars
        public static FishnetStateMgr Singleton { get; private set; }
        ...
        #region Init
        /// <summary>Allow this script to be called from anywhere - there should only ever be one</summary>
        private void Awake() =>
            setSingleton();
            ...
            switch (localConnectionState)
            {
                ...
                case LocalConnectionState.Stopped:
                    ...
                    if (base.ClientState == ClientTrackedState.Connecting)
                        base.OnStartClientFail(ConnectionStoppedFriendlyStr);
                    else
